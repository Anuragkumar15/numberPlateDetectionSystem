...
states={"AN": "Andaman and Nicobar",
        ...
        "ML": "Meghalaya", "MZ": "Mizoram", "NL": "Nagaland", "00": "Odissa",
        "PY": "Pondicherry", "PN": "Punjab", "RJ":"Rajasthan", "SK": "Sikkim", "TN": "TamilNadu", "TR": "Tripura", "UP": "Uttar Pradesh", "WB": "West Bengal", "CG":"Chhattisgarh",
...
def extract_num(img_filename):
    ...
    for(x,y,w,h) in nplate:
        ...
        #make the image more darker to identify LPR
        kernel=np.ones((1,1),np.uint8)
        plate=cv2.dilate(plate,kernel,iterations=1)
        plate=cv2.erode(plate,kernel,iterations=1)
        plate_gray=cv2.cvtColor(plate,cv2.COLOR_BGR2GRAY)
        (thresh,plate)=cv2.threshold(plate_gray,127,255,cv2.THRESH_BINARY)
        #read text on the plate
...
extract_num("a7sp8ji_high-security-number-plates_625x300_12_October_18.webp")